...
{
    public abstract class SomethingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SomethingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SomethingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SomethingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SomethingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SomethingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SomethingDbContext, Task<T>> func)
        {
            T result;
